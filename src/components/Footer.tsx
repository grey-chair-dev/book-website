...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { name: 'Official Website', href: 'https://claireanderson1839.wixsite.com/heirsofeleusaseries', icon: ExternalLink },
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-secondary-300 mb-4">
              Fantasy author and creator of the Heirs of Eleusa series. 
              Wife, high school campus minister, and writer from Cincinnati, OH.
            </p>
            <div className="flex items-center gap-2 text-secondary-300">
              <Globe className="h-4 w-4" aria-hidden="true" />
              <span className="text-sm">Epic Fantasy Series</span>
            </div>
          </div>
